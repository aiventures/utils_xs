@echo off
rem TODO ADAPT py_img_metadata_update.bat [output_path|optional] Extracts Transforms and Updates All Image Metadata in current folder
...
set "cmd_params=--action_show_args -prepare -transform -change"
set "cmd_params=-change"
